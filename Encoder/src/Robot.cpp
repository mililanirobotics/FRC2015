...
public:
	 ...
	 */
	Robot() : m_encoder(1, 2, false, Encoder::k4X), joystick(0), talon(0)
	{
		...
		m_encoder.SetDistancePerPulse(1.0 / 1440);
	...
	void OperatorControl()
	{
		...
		{
			talon.Set(joystick.GetY()); //gets the y-axis on the LEFT logitech
